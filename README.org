#+TITLE: DCOS
#+DESCRIPTION: A post-installation script to install DC's xmonad desktop on an Arch-based distro.
#+AUTHOR: Dhrubajit Chakravarty (DC)
#+PROPERTY: header-args :tangle dtos
#+STARTUP: showeverything

* TABLE OF CONTENT :toc:
- [[#about-dcos][About DCOS]]
- [[#installing-dcos][Installing DCOS]]
...
- [[#contributing-to-dcos][Contributing to DCOS]]
...
- [[#asking-user-to-confirm-choice-to-install-dtos][Asking user to confirm choice to install DCOS.]]
- [[#adding-dtos-repo-to-pacmanconf][Adding DCOS repo to pacman.conf.]]
...
* About DCOS
#+CAPTION: DCOS Scrot
#+ATTR_HTML: :alt DCOS scrot :title DCOS Scrot :align left
[[https://gitlab.com/dwt1/dotfiles/-/raw/master/.screenshots/dtos-thumb-01.png]]

DCOS is the name that I have chosen for my post-installation script that will deploy my Xmonad config, my Emacs config, as well as associated programs that are needed to create a proper "desktop" experience.  DCOS should work on Arch Linux or any Arch-based distribution.  The programs that will be installed include Xmonad, Xmobar, Doom Emacs, Fish and other programs needed to recreate DC's XMonad desktop.

* Installing DCOS
** Installation instructions
To install DCOS, you need to clone this repository and run the ~dtos~ script.
#+begin_example
